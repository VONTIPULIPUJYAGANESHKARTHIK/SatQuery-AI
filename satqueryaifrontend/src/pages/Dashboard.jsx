...
export default function Dashboard() {
  ...
  const renderProfile = () => (
    <motion.div key="profile" variants={viewContainerVariants} initial="hidden" animate="visible" exit="exit" className="max-w-4xl mx-auto pt-6">
      <motion.div variants={viewItemVariants} className="bg-white/70 dark:bg-slate-900/50 backdrop-blur-3xl border border-white/60 dark:border-white/10 rounded-[2.5rem] shadow-xl p-10">
        <div className="flex items-center gap-6 mb-8 border-b border-gray-200/50 dark:border-white/10 pb-8">
          <div className="w-20 h-20 rounded-[2rem] bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 flex items-center justify-center text-3xl font-black shadow border border-gray-100 dark:border-white/10">
            JS
          </div>
          <div>
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tighter">John Smith</h2>
            <p className="text-gray-500 dark:text-gray-400 font-semibold">john@company.com</p>
          </div>
        </div>
      </motion.div>
    </motion.div>
  ...
  const renderSettings = () => (
    <motion.div key="settings" variants={viewContainerVariants} initial="hidden" animate="visible" exit="exit" className="max-w-4xl mx-auto pt-6">
      <motion.div variants={viewItemVariants} className="bg-white/70 dark:bg-slate-900/50 backdrop-blur-3xl border border-white/60 dark:border-white/10 rounded-[2.5rem] shadow-xl p-10">
        <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tighter mb-8">System Settings</h2>
        <p className="text-gray-500 dark:text-gray-400 font-semibold">Configure projection standards and model inference preferences.</p>
      </motion.div>
    </motion.div>
  );
